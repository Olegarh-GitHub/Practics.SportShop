    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_issue_points", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    receive_code = table.Column<int>(type: "integer", nullable: false),
                    issue_point_id = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_orders_issue_points_issue_point_id",
                        column: x => x.issue_point_id,
                        principalTable: "issue_points",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_orders_issue_point_id",
                table: "orders",
                column: "issue_point_id");
